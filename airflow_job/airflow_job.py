...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-gds-oct15")
    bq_project = Variable.get("bq_project", default_var="dogwood-abacus-471514-e7")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "440439553742-compute@developer.gserviceaccount.com",
                "network_uri": "projects/dogwood-abacus-471514-e7/global/networks/default",
                "subnetwork_uri": "projects/dogwood-abacus-471514-e7/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="dogwood-abacus-471514-e7",
        region="us-central1",
